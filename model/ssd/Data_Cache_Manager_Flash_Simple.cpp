...
namespace SSD_Components
{
	...
	void Data_Cache_Manager_Flash_Simple::Execute_MQsim_Simulator_event(MQSimEngine::Sim_Event* ev)
	{
		...
		if (dram_execution_queue[transfer_inf->Stream_id].size() > 0) {
			...
			MQsim_Simulator->Register_sim_event(MQsim_Simulator->Time() + estimate_dram_access_time(new_transfer_info->Size_in_bytes, dram_row_size, dram_busrt_size,
